...
export const InvoiceDocument: React.FC<InvoiceDocumentProps> = ({
  ...
  const baseAmount = Number(invoice.subtotal) - Number(invoice.discount);
  // Los precios de pedidos se almacenan netos; para FCF el IVA no llega calculado desde el backend.
  const ivaAmount = isCCF ? Number(invoice.tax) : baseAmount * 0.13;
  const displayTotal = isCCF ? Number(invoice.total) : baseAmount + ivaAmount;
        ...
        <body>
          ...
          <div class="totals-container"> 
            ...
            <table class="totals-table"> 
              <tr>
                <td class="lbl-td">Suma total de operaciones:</td>
                <td class="val-td">${formatCurrencyTotal(Number(invoice.subtotal))}</td>
              </tr> 
              <tr>
                <td class="lbl-td">Monto global Desc., Rebajas y otros a ventas no sujetas:</td>
                <td class="val-td">$0.00</td>
              </tr> 
              <tr>
                <td class="lbl-td">Monto global Desc., Rebajas y otros a ventas exentas:</td>
                <td class="val-td">$0.00</td>
              </tr> 
              <tr>
                <td class="lbl-td">Monto global Desc., Rebajas y otros a ventas gravadas:</td>
                <td class="val-td">${formatCurrencyTotal(Number(invoice.discount))}</td>
              </tr> 
              <tr>
                <td class="lbl-td">Sub-Total:</td>
                <td class="val-td">${formatCurrencyTotal(Number(invoice.subtotal) - Number(invoice.discount))}</td>
              </tr> 

              <!-- RENDERIZADO CONDICIONAL DEL IVA: Solo visible en Crédito Fiscal -->
              ${
                isCCF
                  ? `
              <tr>
                <td class="lbl-td">Impuesto al valor agregado (IVA 13%):</td>
                <td class="val-td">${formatCurrencyTotal(Number(invoice.tax))}</td>
              </tr>
              `
                  : ""
              }
              ...
              <tr>
                <td class="lbl-td">IVA retenido:</td>
                <td class="val-td">${formatCurrencyTotal(Number(invoice.iva_retenido || 0))}</td>
              </tr> 
              <tr>
                <td class="lbl-td">IVA percibido:</td>
                <td class="val-td">${formatCurrencyTotal(Number(invoice.iva_percibido || 0))}</td>
              </tr> 
              <tr>
                <td class="lbl-td">Retención renta:</td>
                <td class="val-td">${formatCurrencyTotal(Number(invoice.retencion_renta || 0))}</td>
              </tr> 
              <tr>
                <td class="lbl-td">Total a pagar:</td>
                <td class="val-td">${formatCurrencyTotal(displayTotal)}</td>
              </tr> 
              <tr>
                <td class="lbl-td">Total otros montos no afectos:</td>
                <td class="val-td">$0.00</td>
              </tr> 
            </table> 
          </div>
      ...
      <div className="bg-white max-w-[1000px] w-full my-4 rounded-xl shadow-2xl overflow-hidden relative border border-slate-200 dark:bg-slate-800 dark:border-slate-700">
        ...
        <div className="p-10 bg-white text-black font-sans text-[11px] leading-tight dark:bg-slate-800">
          <div className="flex justify-between items-start mb-6">
            <div className="w-2/5">
              <h1 className="text-4xl font-black italic text-blue-900 tracking-tighter">
                LA MAQUILA
              </h1>
            </div>
          ...
          <div className="flex mb-4">
            ...
            <div className="w-2/5 pl-4 text-right">
              ...
              <div className="text-[10px]">
                {formatDate(
                  invoice.fecha_hora_generacion || invoice.created_at,
                )}
              </div>
            </div>
          </div>
          ...
          <div className="flex gap-4 mb-4">
            ...
            <div className="w-1/2 border border-gray-400 rounded-lg p-3 text-[10px] leading-snug">
              ...
              <div className="mb-1">
                <span className="font-bold">Actividad Económica:</span>
                <br />
              ...
              <div className="mb-1">
                ...
                <br />
                ZONA INDUSTRIAL, SAN SALVADOR, EL SALVADOR
              </div>
              <div className="flex mb-1">
                <div className="w-1/2">
                ...
                <div className="w-1/2">
                  ...
                  <br />
                  facturacion@lamaquila.com
                </div>
              </div>
              <div>
                <span className="font-bold">Tipo de establecimiento:</span>
                <br />
                Casa Matriz
              </div>
            </div>
            ...
            <div className="w-1/2 border border-gray-400 rounded-lg p-3 text-[10px] leading-snug">
              ...
              <div className="flex mb-1">
                <div className="w-1/2">
                  <span className="font-bold">NIT:</span>
                  <br />
                  {invoice.receptor_nit || ""}
                </div>
                <div className="w-1/2">
                  <span className="font-bold">NRC:</span>
                  <br />
                  {invoice.receptor_nrc || ""}
                </div>
              </div>
              <div className="mb-1">
                <span className="font-bold">Actividad económica:</span>
                <br />
                {invoice.receptor_actividad_economica || ""}
              </div>
              <div className="mb-1">
                <span className="font-bold">Dirección:</span>
                <br />
              ...
              <div className="flex mb-1">
                <div className="w-1/2">
                  <span className="font-bold">Teléfono:</span>
                  <br />
                  {invoice.receptor_telefono || ""}
                </div>
                <div className="w-1/2">
                  <span className="font-bold">Correo:</span>
                  <br />
                  {invoice.receptor_correo || ""}
                </div>
              </div>
              <div>
                <span className="font-bold">Nombre comercial:</span>
                <br />
                {invoice.receptor_nombre_comercial || ""}
              </div>
            </div>
          </div>
          ...
          <div className="border border-gray-300 rounded overflow-hidden dark:border-slate-600">
            <table className="w-full text-left border-collapse text-[10px]">
              <thead className="bg-gray-200 border-b border-gray-300 dark:bg-slate-700 dark:border-slate-600">
                <tr>
                  <th className="py-1 px-1 text-center border-r border-gray-300 font-bold dark:border-slate-600">
                    No.
                  </th>
                  <th className="py-1 px-1 text-center border-r border-gray-300 font-bold dark:border-slate-600">
                    Cantidad
                  ...
                  <th className="py-1 px-2 border-r border-gray-300 font-bold dark:border-slate-600">
                    Descripción
                  </th>
                  <th className="py-1 px-1 text-center border-r border-gray-300 font-bold leading-tight dark:border-slate-600">
                    Precio
                    <br />
                    Unitario
                  </th>
                  ...
                  <th className="py-1 px-1 text-center font-bold leading-tight">
                    Ventas
                    <br />
                    gravadas
                  </th>
              ...
              <tbody>
                {order?.items && order.items.length > 0 ? (
                  order.items.map((item, index) => (
                    ...
                    >
                      <td className="py-1 px-1 text-center border-r border-gray-200 dark:border-slate-700">
                        {index + 1}
                      </td>
                      <td className="py-1 px-1 text-center border-r border-gray-200 dark:border-slate-700">
                        {item.quantity}
                      ...
                      <td className="py-1 px-2 border-r border-gray-200 dark:border-slate-700">
                        ...
                        {item.attributes && item.attributes.length > 0 && (
                          <div className="text-[9px] text-gray-500 mt-0.5 dark:text-slate-400">
                            {item.attributes
                              .map((attr) => attr.value_label)
                              .join(", ")}
                          </div>
                        )}
                      </td>
                      <td className="py-1 px-1 text-right border-r border-gray-200 dark:border-slate-700">
                      ...
                      <td className="py-1 px-1 text-right font-bold">
                        {formatCurrencyTotal(item.subtotal)}
                      </td>
                    </tr>
                  ))
                ) : (
                  <tr className="border-b border-gray-200 dark:border-slate-700">
                    <td
                      colSpan={10}
                      className="py-4 text-center text-gray-500 font-semibold dark:text-slate-400"
                    >
              ...
              <tfoot>
                <tr>
                  <td
                    colSpan={7}
                    className="border-r border-gray-200 border-t border-gray-200 dark:border-slate-700"
                  ></td>
                  <td
                    colSpan={2}
                    className="py-1 px-1 text-right border-r border-t border-gray-200 font-bold dark:border-slate-700"
                  >
                    Suma de ventas:
                  </td>
                  <td className="py-1 px-1 text-right border-t border-gray-200 font-bold dark:border-slate-700">
                    {formatCurrencyTotal(Number(invoice.subtotal))}
                  </td>
                </tr>
              </tfoot>
            </table>
          ...
          <div className="flex mt-0 text-[10px]">
            <div className="w-[55%] flex flex-col items-center justify-end pb-8 border border-gray-300 border-t-0 border-r-0 dark:border-slate-600"></div>
            <div className="w-[45%]">
              <table className="w-full border-collapse">
                <tbody>
                  <tr>
                    <td className="border border-gray-300 px-2 py-1 text-right font-bold w-[70%] dark:border-slate-600">
                      Suma total de operaciones:
                    </td>
                    <td className="border border-gray-300 px-2 py-1 text-right w-[30%] dark:border-slate-600">
                      {formatCurrencyTotal(Number(invoice.subtotal))}
                    </td>
                  </tr>
                  <tr>
                    <td className="border border-gray-300 px-2 py-1 text-right font-bold text-[9px] dark:border-slate-600">
                      Monto global Desc., Rebajas y otros a ventas no sujetas:
                    </td>
                    <td className="border border-gray-300 px-2 py-1 text-right dark:border-slate-600">
                      $0.00
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td className="border border-gray-300 px-2 py-1 text-right dark:border-slate-600">
                      {formatCurrencyTotal(Number(invoice.discount))}
                    </td>
                  </tr>
                  <tr>
                    <td className="border border-gray-300 px-2 py-1 text-right font-bold dark:border-slate-600">
                      Sub-Total:
                    </td>
                    <td className="border border-gray-300 px-2 py-1 text-right dark:border-slate-600">
                      {formatCurrencyTotal(
                  ...
                  {isCCF && (
                    <tr>
                      ...
                      <td className="border border-gray-300 px-2 py-1 text-right dark:border-slate-600">
                        {formatCurrencyTotal(Number(invoice.tax))}
                      </td>
                    </tr>
                  )}
                  ...
                  <tr>
                    ...
                    <td className="border border-gray-300 px-2 py-1 text-right dark:border-slate-600">
                      {formatCurrencyTotal(Number(invoice.iva_retenido || 0))}
                    </td>
                  </tr>
                  <tr>
                    <td className="border border-gray-300 px-2 py-1 text-right font-bold dark:border-slate-600">
                    ...
                    <td className="border border-gray-300 px-2 py-1 text-right dark:border-slate-600">
                      {formatCurrencyTotal(Number(invoice.iva_percibido || 0))}
                    </td>
                  </tr>
                  <tr>
                    <td className="border border-gray-300 px-2 py-1 text-right font-bold dark:border-slate-600">
                    ...
                    <td className="border border-gray-300 px-2 py-1 text-right dark:border-slate-600">
                      {formatCurrencyTotal(
                        Number(invoice.retencion_renta || 0),
                      )}
                    </td>
                  </tr>
                  <tr>
                    <td className="border border-gray-300 px-2 py-1 text-right font-bold bg-gray-100 dark:bg-slate-800 dark:border-slate-600">
                      Total a pagar:
                    </td>
                    <td className="border border-gray-300 px-2 py-1 text-right font-bold bg-gray-100 dark:bg-slate-800 dark:border-slate-600">
                      {formatCurrencyTotal(displayTotal)}
                    </td>
                  </tr>
                  <tr>
                    <td className="border border-gray-300 px-2 py-1 text-right font-bold dark:border-slate-600">
